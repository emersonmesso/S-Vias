...
public class ViewDenunciaInstituicao extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //verificando se o botão pode ou não ser visto

        if(foto.size() > 1){
            //mostra o botão de ver mais fotos
            btnViewImages.setVisibility(View.VISIBLE);
        }else{
            //não mostra o botão de ver mais fotos
        ...
        if(foto.equals("")){
            ...
            DownloadImageFromInternet img = new DownloadImageFromInternet(imgDenuncia,this);
    ...
    private class AtualizaSituacao extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if(!result.equals("")){
                ...
                if(IDSituacao == 3 || IDSituacao == 2){
                    //inicia a tela para adicionar novas imagens
                    Intent i = new Intent(ViewDenunciaInstituicao.this, AddImages.class);
                    i.putExtra("id_loc", id_loc);
                    i.putExtra("sit", IDSituacao);
                    startActivity(i);
                }
            }
            exibirProgress(false);
