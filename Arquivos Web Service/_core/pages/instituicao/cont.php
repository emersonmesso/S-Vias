...
<div class="container">
    <div id="content-op" class="row" hidden="true" >
        <div id="modal" class="col align-self-center">
            ...
            <br/>
            <label id="label-modal-ft" style="padding-bottom: 2vh;"> Carregar fotos (Opcional) :
...
//variavel para calcular o início da visualização com base na página atual 
        ...
        foreach ($denuncias as $denuncia) {
            ...
            echo PHP_EOL . '<td id="title-tt">' . utf8_decode($denuncia["titulo"]) . '</td>';
            echo PHP_EOL . '<td>' . utf8_decode($denuncia["descricao"]) . '</td>';
